...
class chat extends \block_openai_chat\completion {
    ...
    public function create_completion($context) {
        ...
        # something don't need
        //return $this->make_api_call($history_json);
        return $this->make_api_call($context->block_id);
    }
     ...
     */
    private function make_api_call($block_id) {
        // $curlbody = [
        //     "model" => $this->model,
        //     "messages" => $history,
        ...
        $response = $curl->post("http://localhost:8000/v1/chat/", json_encode($curlbody));
