...
$string['ai_chat:addinstance'] = 'Add a new AI Chat block';
$string['ai_chat:myaddinstance'] = 'Add a new AI Chat block to the My Moodle page';
$string['privacy:metadata'] = 'The AI Chat block stores no personal user data; nor does it, by default, send personal data to AI. However, chat messages submitted by users are sent in their entirety to AI, and are then subject to AI\'s privacy policy (https://openai.com/api/policies/privacy/), which may store messages in order to improve the API.';
...
$string['apikeydesc'] = 'The API Key for your AI account or Azure API key';
...
$string['assistantdesc'] = 'The default assistant attached to your AI account that you would like to use for the response';
$string['noassistants'] = 'You haven\'t created any assistants yet. You need to create one <a target="_blank" href="https://platform.openai.com/assistants">in your AI account</a> before you can select it here.';
...
$string['resourcenamedesc'] = 'The name of your Azure AI Resource.';
...
$string['advanceddesc'] = 'Advanced arguments sent to AI. Don\'t touch unless you know what you\'re doing!';
...
$string['config_assistant_help'] = "Choose the assistant you would like to use for this block. More assistants can be created in the AI account that this block is configured to use.";
...
$string['apikeymissing'] = 'Please add your AI API key to the global block settings.';
